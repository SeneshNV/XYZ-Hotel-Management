...
################################################################################
## Form generated from reading UI file 'view_packageXvwYjA.ui'
##
...
class Ui_view_package_form(object):
    def setupUi(self, view_package_form):
        ...
        view_package_form.resize(650, 529)
        view_package_form.setMinimumSize(QSize(335, 400))
        view_package_form.setStyleSheet(u"border:none;")
        self.horizontalLayout = QHBoxLayout(view_package_form)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.scrollArea = QScrollArea(view_package_form)
...
"")
    ...
    def retranslateUi(self, view_package_form):
        ...
        self.txt_search.setPlaceholderText(QCoreApplication.translate("view_package_form", u"Search Staff", None))
